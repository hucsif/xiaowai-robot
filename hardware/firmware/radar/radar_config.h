 ...
 * 当前为 0：雷达未接线（缺杜邦线），先跑语音链路；接线后改回 1 即可。 */
#ifndef DESKBOT_RADAR_ENABLE
#define DESKBOT_RADAR_ENABLE 0
#endif
